                ...
                <div className='gap-4 mx-2 mb-8 md:grid md:grid-cols-3'>
                    {
                        experience.map((exp) => (
                            <div key={exp.title} className='h-fit flex flex-col pb-2 shadow-lg md:shadow md:hover:shadow-xl'>
                                ...
                                {exp.hasArtical && <Link to={exp.link} className="mb-2 w-fit h-fit mx-auto"><button className='rounded-lg p-2 bg-amber-200 text-xl w-fit'>View more</button></Link>}
                                {!exp.hasArtical && <button className='mx-auto mb-2 rounded-lg p-2 bg-amber-200 opacity-30 text-xl w-fit' disabled>View more</button>}
                            </div>
                        ))
                    }
                </div>
